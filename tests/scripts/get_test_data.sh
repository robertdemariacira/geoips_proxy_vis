...
m10_subdir=pvis_test_data/m10/20241008/1700/
m10_tar_filename=m10_2024-10-08T17.tar
...
mkdir -p $m10_subdir
pushd $m10_subdir
wget https://irma.cira.colostate.edu/index.php/s/zbgkRNWpBnstQ6T/download/$m10_tar_filename
tar -xf $m10_tar_filename
rm $m10_tar_filename
popd
